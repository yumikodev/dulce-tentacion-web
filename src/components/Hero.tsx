...
function Hero() {
  return (
    <main className="px-3 flex flex-col gap-6 justify-center items-center h-dvh bg-[url(/imgs/hero-img.avif)] bg-cover bg-center relative overflow-hidden transition-all duration-300 sm:px-6 md:px-8">
      ...
      <h1 className="animate-fadeInDown text-6xl font-passion-one max-w-screen-lg bg-linear-120 from-rose-50 to-rose-500 to-80% bg-clip-text text-transparent text-center z-10 md:text-8xl xl:text-9xl">
